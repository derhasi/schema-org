...
class GenerateCommand extends Command
{
    ...
    {
        $this->setName('generate')->setDescription('Generate the package code from the schema.org docs')->addArgument('source', InputArgument::OPTIONAL, 'Path to the RDFa source file', static::SOURCE);
    }
    /**
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $generator->generate(file_get_contents($input->getArgument('source')));
